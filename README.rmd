...
Dans le rapport technique [@Boutry2021], la démarche scientifique décrit les différentes étapes de la construction de l'IBDL.
...
**`table_lacs`** Table regroupant les informations sur la classification des lacs selon l'alcalinité [@Kelly2014] et le nombre théoriques d'unités d'observation à échantillonner sur le plan d'eau selon leur superficie [@afnorXP].
