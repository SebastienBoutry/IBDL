...
L'objectif de ce package `{IBDL}` est de fournir les fonctions nécessaires pour calculer l'Indice Biologique Diatomées en Lacs.
...
```{r taxons alertes, echo=FALSE, results='asis'}
